...
urlpatterns = [
    ...
    path('add_language/', MyLanguage, name = 'create_language'),
    path('edit_language/<int:pk>', EditLanguage, name = 'edit_language'),
    path('add_award/', MyAward, name = 'create_award'),
    path('edit_award/<int:pk>', EditAward, name = 'edit_award'),
    path('add_experience/', MyExperience, name = 'create_experience'),
    path('edit_experience/<int:pk>', EditExperience, name = 'edit_experience'),
    path('add_education/', MyEducation, name = 'create_education'),
    path('edit_education/<int:pk>', EditEducation, name = 'edit_education'),
    path('add_skills/', MySkills, name = 'create_skills'),
    path('edit_skills/<int:pk>', EditSkills, name = 'edit_skills'),
    path('add_project/', MyProject, name = 'create_project'),
