...
urlpatterns =  [
    ...
    path('create-award/<int:personal_detail_pk>/', views.createAward, name='create_award'),
    path('get-award/<int:pk>/', views.getAward, name='get_award'),
    path('update-award/<int:pk>/<int:personal_detail_pk>/', views.updateAward, name='update_award'),
    path('delete-award/<int:pk>/<int:personal_detail_pk>/', views.deleteAward, name='delete_award'),
    path('create-certificate/<int:personal_detail_pk>/', views.createCertificate, name='create_certificate'),
    path('get-certificate/<int:pk>/', views.getCertificate, name='get_certificate'),
    path('update-certificate/<int:pk>/<int:personal_detail_pk>/', views.updateCertificate, name='update_certificate'),
    path('delete-certificate/<int:pk>/<int:personal_detail_pk>/', views.deleteCertificate, name='delete_certificate'),
    path('create-interest/<int:personal_detail_pk>/', views.createInterest, name='create_interest'),
    path('get-interest/<int:pk>/', views.getInterest, name='get_interest'),
    path('update-interest/<int:pk>/<int:personal_detail_pk>/', views.updateInterest, name='update_interest'),
    path('delete-interest/<int:pk>/<int:personal_detail_pk>/', views.deleteInterest, name='delete_interest'),
    path('create-publication/<int:personal_detail_pk>/', views.createPublication, name='create_publication'),
    path('get-publication/<int:pk>/', views.getPublication, name='get_publication'),
    path('update-publication/<int:pk>/<int:personal_detail_pk>/', views.updatePublication, name='update_publication'),
    path('delete-publication/<int:pk>/<int:personal_detail_pk>/', views.deletePublication, name='delete_publication'),
]
